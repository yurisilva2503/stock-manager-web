...
## Observação 🧐
- O dump para criação do schema do banco de dados no mysql workbench 8.0 está na pasta dump, então é só reproduzir e alterar as credenciais da conexão no aquivo db.js na pasta server.
